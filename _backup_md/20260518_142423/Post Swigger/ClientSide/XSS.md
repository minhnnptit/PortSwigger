...
![[Pasted image 20260415201621.png]]
## Tác động của XSS
...
![[Pasted image 20260415203414.png]]
- trang web có lỗ hổng reflected XSS ở phần tìm kiếm
- chèn payload: `<script>alert(1)</script>` để solve lab
![[Pasted image 20260415203702.png]]
![[Pasted image 20260415203758.png]]

## Stored XSS into HTML context with nothing encoded

![[Pasted image 20260415210311.png]]
- vào 1 bài post và xuống phần comment:
![[Pasted image 20260415220921.png]]
- khi quay lại bài blog thì alert đã xuất hiện
![[Pasted image 20260415221000.png]]

## DOM XSS in `document.write` sink using source `location.search`

![[Pasted image 20260416114314.png]]
...
![[Pasted image 20260416114656.png]]


- chèn payload: `"> <script>alert(1)</script>`
![[Pasted image 20260416115116.png]]


## DOM XSS in `innerHTML` sink using source `location.search`

- ở bài lab này: payload: `<img src=1 onerror=alert(1)>`
![[Pasted image 20260503042804.png]]
...
![[Pasted image 20260503043339.png]]


![[Pasted image 20260503043430.png]]

## DOM XSS in jQuery selector sink using a hashchange event

- ở bài lab này: khai thác cách jQuery xử lý các chuỗi nằm sau dấu thăng (`#`) trên URL
![[Pasted image 20260503043917.png]]
...
![[Pasted image 20260503044153.png]]

## Reflected XSS into attribute with angle brackets HTML-encoded

![[Pasted image 20260503044545.png]]
...
![[Pasted image 20260503044651.png]]


## Stored XSS into anchor `href` attribute with double quotes HTML-encoded

![[Pasted image 20260503045110.png]]


![[Pasted image 20260503045417.png]]
...
![[Pasted image 20260503050117.png]]
...
![[Pasted image 20260503050308.png]]

## DOM XSS in AngularJS expression with angle brackets and double quotes HTML-encoded

- thử tìm hiếm `<minh>` 

![[Pasted image 20260503050701.png]]
...
![[Pasted image 20260503051300.png]]

- ở file searchResult.js, có hàm eval xử lí dữ liệu từ js
![[Pasted image 20260503051408.png]]
...
![[Pasted image 20260503052049.png]]
![[Pasted image 20260503052208.png]]
...
![[Pasted image 20260503053406.png]]
...
![[Pasted image 20260503053922.png]]
- nhưng lại ko chặn các customs tags
![[Pasted image 20260503054002.png]]
...
![[Pasted image 20260503174046.png]]

- dùng burp brute force xem tags nào ko bị block
![[Pasted image 20260503174458.png]]
...
![[Pasted image 20260503174745.png]]
...
![[Pasted image 20260503174910.png]]

## Reflected XSS in canonical link tag

![[Pasted image 20260503175234.png]]
...
![[Pasted image 20260503175635.png]]
...
![[Pasted image 20260503180532.png]]

## Reflected XSS into a JavaScript string with single quote and backslash escaped
- khi nhập minh'123 vào ô search, ở mã nguồn, nó bị biến thành: minh\'123
- khi nhập minh\123:
![[Pasted image 20260503181234.png]]

![[Pasted image 20260503181323.png]]
...
payload: ![[Pasted image 20260503181422.png]]
...
![[Pasted image 20260503181545.png]]
...
![[Pasted image 20260503190647.png]]
...
![[Pasted image 20260503195140.png]]
...
![[Pasted image 20260503195812.png]]
...
![[Pasted image 20260503201922.png]]
...
![[Pasted image 20260503210328.png]]
...
- 
![[Pasted image 20260503220313.png]]

![[Pasted image 20260503220350.png]]
...
![[Pasted image 20260503220456.png]]
...
![[Pasted image 20260503220939.png]]
...
![[Pasted image 20260503222204.png]]
...
![[Pasted image 20260503221927.png]]
...
![[Pasted image 20260503223038.png]]
...
![[Pasted image 20260503224822.png]]
...
![[Pasted image 20260503232110.png]]
