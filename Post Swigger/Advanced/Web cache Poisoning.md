...
- [Xây dựng cuộc tấn công](#xây-dựng-cuộc-tấn-công)
  - [Identify and evaluate unkeyed inputs](#identify-and-evaluate-unkeyed-inputs)
    - [Param Miner](#param-miner)
  - [Gây ra phản hồi độc hại từ máy chủ back-end](#gây-ra-phản-hồi-độc-hại-từ-máy-chủ-back-end)
  - [**Làm cho phản hồi được lưu vào cache**](#làm-cho-phản-hồi-được-lưu-vào-cache)
- [**Khai thác các lỗi thiết kế của cache**](#khai-thác-các-lỗi-thiết-kế-của-cache)
  - [XSS](#xss)
...
- [Khai thác các lỗi triển khai cache](#khai-thác-các-lỗi-triển-khai-cache)
...
- [**Khai thác các lỗi khóa cache**](#khai-thác-các-lỗi-khóa-cache)
